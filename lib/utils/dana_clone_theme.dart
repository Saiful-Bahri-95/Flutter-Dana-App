...
class DanaCloneTheme {
  ...
  static TextTheme primaryTextTheme = TextTheme(
    // Service: DANA Deals, Feed, Whats New, Nearby: please allow
  ...
  static TextTheme textTheme = TextTheme(
    ...
    titleSmall: GoogleFonts.roboto(fontSize: 15, color: secondaryBlack),
    // Whats New: Belanja
  ...
  static ThemeData themeData() {
    return ThemeData(
      appBarTheme: const AppBarTheme(backgroundColor: mainBlue),
      ...
      outlinedButtonTheme: OutlinedButtonThemeData(
        style: OutlinedButton.styleFrom(
          side: const BorderSide(color: outlineButtonBlue),
