...
import 'package:flutter_dana_app/utils/utils.dart';
import 'package:flutter_dana_app/widgets/widgets.dart';
      ...
      children: [
        Container(
          ...
          decoration: BoxDecoration(
            border: Border(top: BorderSide(color: DanaCloneTheme.lightGrey)),
          ),
          child: BottomAppBar(
            child: Row(
        ...
        Align(alignment: Alignment.center, child: ButtonPay()),
      ],
    );
  }
}
